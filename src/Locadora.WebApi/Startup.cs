...
namespace Locadora.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LocadoraContext>(context => context.UseSqlServer(Configuration.GetConnectionString("LocadoraConnection")));

            services.AddControllers();
            services.AddTransient<RepositorioCliente>();
